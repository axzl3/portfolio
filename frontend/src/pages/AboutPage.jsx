  ...
  return (
    <div className="p-6">
      ...
      <div className="text-md">
        ...
        PostgreSQL/MongoDB, Node.js, Express, and
        React/Vue.js. Passionate about crafting
        seamless user experiences and efficient
        backend systems, I thrive in solving
        complex problems and developing innovative
        solutions.
      </div>
